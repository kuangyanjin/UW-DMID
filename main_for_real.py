...
if __name__ == "__main__":
    ...
    parser.add_argument('--clean_path', default='./data/FMDD/GT/', type=str, help='for example: ./data/CC/clean/')
    parser.add_argument('--noisy_path', default='./results/nn_FMDD/FMDD.pt', type=str, help='for example: ./data/CC/noisy/')
    parser.add_argument('--datatype', default='FMDD', type=str, help='CC/PolyU/FMDD')
    parser.add_argument('--S_t', default=3, type=int, help='sampling times in one inference')
    parser.add_argument('--R_t', default=333, type=int, help='repetition times of multiple inferences')
